...
var global = this
  ...
  , Split = function (ids, options) {
    ...
    var startDragging = function (e) {
            ...
            if (!e.target.href && e.target.localName != "a" && e.target.classList != "to-top") {
/*
              console.log("e.target.localName: "+e.target.localName+", e.target.classList: "+e.target.classList);
              console.log(e);
*/
    ...
    for (i = 0; i < ids.length; i++) {
        ...
        if (!isIE8) {
            ...
            if (i > 0) {
                ...
                //check if a split_gutter exists
                if (document.getElementById("split_gutter")) {
                  var gutter = document.getElementById("split_gutter")
                } else {
                ...
                //check if a split_gutter exists before inserting
                if (!document.getElementById("split_gutter")) {
...
/*
     FILE ARCHIVED ON 05:22:05 Mar 13, 2018 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  LoadShardBlock: 29.482 (3)
  esindex: 0.009
  captures_list: 48.511
  CDXLines.iter: 12.574 (3)
  PetaboxLoader3.datanode: 75.294 (5)
  exclusion.robots: 0.221
  exclusion.robots.policy: 0.195
  RedisCDXSource: 1.706
  PetaboxLoader3.resolve: 53.219 (2)
  load_resource: 131.314
*/